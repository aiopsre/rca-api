...
type AIJobM struct {
	...
	RunTraceJSON      *string    `gorm:"column:run_trace_json;type:longtext" json:"run_trace_json"`
	DecisionTraceJSON *string    `gorm:"column:decision_trace_json;type:longtext" json:"decision_trace_json"`
