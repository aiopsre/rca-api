...
type FakeM struct {
	...
	CreatedAt time.Time `json:"createdAt" gorm:"column:createdAt;type:datetime;not null;default:CURRENT_TIMESTAMP;comment:资源创建时间"`   // 资源创建时间
	UpdatedAt time.Time `json:"updatedAt" gorm:"column:updatedAt;type:datetime;not null;default:CURRENT_TIMESTAMP;comment:资源最后修改时间"` // 资源最后修改时间
}
