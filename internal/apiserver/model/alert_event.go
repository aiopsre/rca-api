...
type AlertEventM struct {
	...
	CreatedAt      time.Time  `gorm:"column:created_at;type:datetime;index:idx_alert_events_incident_id_created_at,priority:2;not null;default:CURRENT_TIMESTAMP" json:"created_at"`
