...
type NoticeDeliveryM struct {
	...
	NextRetryAt               time.Time  `gorm:"column:next_retry_at;type:datetime;not null;default:CURRENT_TIMESTAMP;index:idx_notice_deliveries_status_retry,priority:2" json:"next_retry_at"`
